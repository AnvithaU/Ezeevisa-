...
export const GetVisaCountriesResponseItem = zod.object({
  ...
  "visaTypes": zod.array(zod.object({
  "type": zod.string(),
  "label": zod.string(),
  "duration": zod.string(),
  "fee": zod.number()
...
export const ListApplicationsQueryParams = zod.object({
  "status": zod.enum(['draft', 'submitted', 'under_review', 'approved', 'rejected', 'all']).optional(),
...
export const GetRecentActivityResponseItem = zod.object({
  "id": zod.number(),
  "type": zod.enum(['application_created', 'application_submitted', 'status_changed', 'document_uploaded']),
  "applicationId": zod.number(),
  "countryName": zod.string(),
  "countryFlag": zod.string(),
