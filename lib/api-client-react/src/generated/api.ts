...
export const getGetVisaCountriesQueryKey = () => {
  return [`/api/visas/countries`] as const;
};

export const getGetVisaCountriesQueryOptions = <
  TData = Awaited<ReturnType<typeof getVisaCountries>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getVisaCountries>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getVisaCountries>>
  > = ({ signal }) => getVisaCountries({ signal, ...requestOptions });
...
export type GetVisaCountriesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVisaCountries>>
>;
...
export function useGetVisaCountries<
  TData = Awaited<ReturnType<typeof getVisaCountries>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getVisaCountry = async (
  countryCode: string,
  options?: RequestInit,
): Promise<VisaCountry> => {
...
export const getGetVisaCountryQueryKey = (countryCode: string) => {
  return [`/api/visas/countries/${countryCode}`] as const;
};

export const getGetVisaCountryQueryOptions = <
  TData = Awaited<ReturnType<typeof getVisaCountry>>,
  TError = ErrorType<ErrorResponse>,
>(
  countryCode: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getVisaCountry>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetVisaCountryQueryKey(countryCode);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getVisaCountry>>> = ({
    signal,
  }) => getVisaCountry(countryCode, { signal, ...requestOptions });
...
export type GetVisaCountryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVisaCountry>>
>;
...
export function useGetVisaCountry<
  TData = Awaited<ReturnType<typeof getVisaCountry>>,
  TError = ErrorType<ErrorResponse>,
>(
  countryCode: string,
...
export const getListApplicationDocumentsQueryOptions = <
  TData = Awaited<ReturnType<typeof listApplicationDocuments>>,
  TError = ErrorType<ErrorResponse>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listApplicationDocuments>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListApplicationDocumentsQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listApplicationDocuments>>
  > = ({ signal }) =>
    listApplicationDocuments(id, { signal, ...requestOptions });
...
export type ListApplicationDocumentsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listApplicationDocuments>>
>;
...
export function useListApplicationDocuments<
  TData = Awaited<ReturnType<typeof listApplicationDocuments>>,
  TError = ErrorType<ErrorResponse>,
>(
  id: number,
